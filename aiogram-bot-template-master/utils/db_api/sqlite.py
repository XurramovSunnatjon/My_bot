...
class Database:
    ...
    def add_video(self, id: str, url: str, malumot: str):
        # SQL_EXAMPLE = "INSERT INTO Users(id, Name, email) VALUES(1, 'John', 'John@gmail.com')"

        sql = """
        INSERT INTO videos(id, url, malumot) VALUES(?, ?, ?)
        """
        self.execute(sql, parameters=(id, url, malumot), commit=True)
    ...
    def count_videos(self):
        return self.execute("SELECT COUNT(*) FROM videos;", fetchone=True)
